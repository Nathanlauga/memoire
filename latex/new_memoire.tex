...
\paragraph{}
En préalable, je tiens à préciser que ce mémoire ayant pour but d’être lisible (au moins l'\uppercase{é}tat de l'Art) par tous, aucune maîtrise dans le domaine de l’intelligence artificielle ou de la morale ne sont requis pour le lire, bien que cela puisse aider pour certains passages. Le domaine de recherche alliant intelligence artificielle et éthique (morale) étant récent, il est possible que des recherches présentées dans ce document soient incomplètes voire obsolètes dans un futur plus ou moins proche.

\paragraph{}
Ce mémoire s’inscrit dans le cadre de ma scolarité au sein de l’école Ingésup Bordeaux du campus Ynov ainsi que dans le cadre de mon alternance dans l’entreprise Caisse d’épargne Aquitaine Poitou Charentes, où je travaille en tant que Data Scientist dans un service d’informatique décisionnelle. L’objectif de ce document est d’introduire les concepts sous-jacents de la problématique soulevés par ce mémoire. De plus, ce mémoire sera soutenu en septembre 2020.
...
\paragraph{}
Ce mémoire provient d'environ d'un an et demi de travail et pour cela, je souhaite dans un premier temps remercier toutes les personnes avec lesquelles j'ai pu échanger et qui ont pu m'apporter une aide directe ou indirecte.

\paragraph{}
Je tiens tout d'abord à remercier mon tuteur, Pascal FOURNIER, responsable du département de développement et décisionnel au sein de la Caisse Aquitaine Poitou-Charentes, qui m'a accompagné et permis de poser la question de l'éthique au sein d'une banque en pouvant construire mon outil en le laissant ``Open-Source''. 
