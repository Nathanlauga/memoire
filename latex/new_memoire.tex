...
\begin{abstract}
\addcontentsline{toc}{chapter}{\bf Avant-propos}  
\paragraph{}
En préalable, je tiens à préciser que ce mémoire ayant pour but d’être lisible (au moins l'\uppercase{é}tat de l'Art) par tous, aucune maîtrise dans le domaine de l’intelligence artificielle ou de la morale n'est requise pour le lire, bien que cela puisse aider pour certains passages. Le domaine de recherche alliant intelligence artificielle et éthique (morale) étant récent, il est possible que des recherches présentées dans ce document soient incomplètes voire obsolètes dans un futur plus ou moins proche.

\paragraph{}
Ce mémoire s’inscrit dans le cadre de ma scolarité au sein de l’école Ingésup Bordeaux du campus Ynov ainsi que dans celui de mon alternance dans l’entreprise Caisse d’épargne Aquitaine Poitou Charentes, où je travaille en tant que Data Scientist dans un service d’informatique décisionnelle. L’objectif de ce document est d’introduire les concepts sous-jacents de la problématique soulevée par ce mémoire. De plus, ce mémoire sera soutenu en septembre 2020.

\paragraph{}
Le lecteur, non familier de la littérature scientifique et de sciences humaines, pourrait être surpris par certaines dates de référence semblant trop récentes pour certains auteurs. En effet, les dates citées correspondent à celle de l’édition, e.g. (Kant, 2006) ne signifie pas que Kant a publié un livre en 2006, mais que l’ouvrage qui est référencé est une édition de 2006.

\paragraph{}
Les propos discutés ici pouvant traiter de questions sociales ou encore morales, il est important de préciser que j’ai cherché à les détailler de manière objective, mais étant moi-même soumis à ma vision idéologique du monde, je ne peux garantir une parfaite impartialité sur le fond des écrits (e.g. la moralisation d’algorithme est essentielle à mes yeux).
...
\newpage
\begin{remerciements}
\addcontentsline{toc}{chapter}{\bf Remerciements}  

\paragraph{}
Ce mémoire provient d'un an et demi de travail et pour cela, je souhaite dans un premier temps remercier toutes les personnes avec lesquelles j'ai pu échanger et qui ont pu m'apporter une aide directe ou indirecte.

\paragraph{}
Je tiens tout d'abord à remercier mon tuteur, Pascal FOURNIER, responsable du département développement et décisionnel au sein de la Caisse Aquitaine Poitou-Charentes, qui m'a accompagné et permis de poser la question de l'éthique au sein d'une banque, j'ai pu ainsi construire mon outil en le laissant ``Open-Source''. 

\paragraph{}
Merci à Nicolas TARBES, Philippe DEROUETTE, Delphine GLOUX et Lucie CASSISA, collaborateurs d'IT-CE, m'ayant challengé sur la conception de l'outil TransparentAI tout en apportant des solutions très pertinentes. 

\paragraph{}
Merci à Clément ROMAC et Pierre LEROY qui m’ont permis de découvrir le domaine de recherche de l’intelligence artificielle et de l’éthique.

\paragraph{}
Merci à Loïc BRIENT, Rob HARRELL et Luke MERRICK pour leurs réponses lors d'un entretien m'apportant des briques supplémentaires pour enrichir le mémoire.

\paragraph{}
Enfin, j'adresse mes plus sincères remerciements à mes parents, mes proches et amis, qui m'ont suivi, accompagné, soutenu, aidé et encouragé tout le long de la construction et réalisation de ce mémoire.
...
\begin{center}
  \begin{figure}[hbt!]
    \makebox[\textwidth]{\includegraphics[width=0.85\paperwidth]{images/capture_ecran_transparentai_ui.png}}
